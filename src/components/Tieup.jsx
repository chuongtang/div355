      ...
      <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
            ...
            >
              <span className="inline-block rounded-lg bg-gray-50 p-3">
                <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" transform="translate(2 4)"><path d="m13.5 4.5h2c.5522847 0 1-.44771525 1-1v-2c0-.55228475-.4477153-1-1-1h-14c-.55228475 0-1 .44771525-1 1v2c0 .55228475.44771525 1 1 1h2" /><path d="m3.5.5h10v11.5c0 .5522847-.4477153 1-1 1h-8c-.55228475 0-1-.4477153-1-1z" /><path d="m6.5 7.5 2 2 2-2" /><path d="m8.5 9.5v-6" /></g></svg>
              </span>
            ...
            >
              <span className="inline-block rounded-lg bg-gray-50 p-3">
                <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" transform="matrix(-1 0 0 1 19 2)"><circle cx="8.5" cy="8.5" r="8" /><path d="m8.5 5.5v4h-3.5" /></g></svg>
              </span>

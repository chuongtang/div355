          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-10 sm:flex sm:items-center sm:space-x-8">
                ...
                <a href="/login" className="underline decoration-yellow-500 decoration-4 text-shadow-sm inline-flex items-center mt-6 text-base font-semibold transition-all duration-200 sm:mt-0 hover:opacity-80"
                  >
